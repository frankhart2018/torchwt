...
from ..parser.json import layer_parser
...
class Model(nn.Module):
    ...
    def __read_model_from_json(self):
        return json_reader.JSONReader.read_json(
            json_file_path=self.__model_spec_file,
            error_class=errors.ModelFileNotFound,
            error_message=f"{self.__model_spec_file} not found, make sure you pass correct model specification file!"
        )
